...
clear
echo $y"TUNGGU" $p"BOSKU" $g".................." 
sleep 3

clear
echo $p"SABAR" $g"BRO" $r"................."
sleep 3
...
clear
echo $g"TAPI" $b"BOONG" $r"AWOKAWOKAWOK" $cy".................."
sleep 3

clear
echo $g"SATU" $b"LAGI" $r"NIH" $cy".................."
sleep 3
...
figlet "Tools"
echo $w"=========================================="
echo $g" Author"$r"  : "$cy"MR.L4M3R"
echo $g" YouTube"$r" : "$cy"MR.L4M3RXploit"
echo $g"  Team"$r"    : "$cy"Sumber Cyber Team"
echo $w"=========================================="
echo
